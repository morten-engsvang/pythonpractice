...
def evaluate_models_on_training(x, y, models):
    ...
    FigNum = 1
    for i in models:
        pylab.figure("Figure: " + str(FigNum))
        estimated = []
        for j in x:
            estimated.append(pylab.polyval(i,j))
        pylab.title("Degree: " + str(len(i)-1) + ", R^2: " + str(r_squared(y,estimated)))
        pylab.plot(x,y,"ob",label = "Data")
        pylab.plot(x,estimated,"-r",label = "Fit")
        pylab.xlabel("Year")

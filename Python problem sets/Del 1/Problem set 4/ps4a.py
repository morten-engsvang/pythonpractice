...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        letterstring = ""
        for letter in hand:
            letterstring += (letter+" ")*hand[letter]
        print("Current Hand:", letterstring)
        # Ask user for input
        ...
        # Otherwise (the input is not a single period):
            ...
            # Otherwise (the word is valid):
                ...
                tot_score += getWordScore(word, n)
                print('"', word, '"', "earned", getWordScore(word, n), "points.", "Total: ", tot_score, "points.")
                # Update the hand 
